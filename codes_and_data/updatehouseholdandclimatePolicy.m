Utility_Policy_steady=zeros(1,NRegions);
...
for j=1:NRegions
Utility_Policy_steady(j)=UD*((((Cons_steady(1,:,j)').^(1-sigma)-1))/(1-sigma).*POP(Tlast,:,j)');
end
for i=2:Gen_Number
...
K_steady_guess=0.95*K_steady_guess+0.05*K_supply_ss;
